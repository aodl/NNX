export const TOPOLOGY_ERROR_CODES = Object.freeze({
  ...
  REGISTRY_RECORD_UNAVAILABLE: 'REGISTRY_RECORD_UNAVAILABLE',
  REGISTRY_RECORD_DECODE_FAILED: 'REGISTRY_RECORD_DECODE_FAILED',
  REGISTRY_RECORD_PARTIAL: 'REGISTRY_RECORD_PARTIAL',
  REGISTRY_VERSION_INCONSISTENT: 'REGISTRY_VERSION_INCONSISTENT',
  REGISTRY_LARGE_VALUE_UNSUPPORTED: 'REGISTRY_LARGE_VALUE_UNSUPPORTED',
});
